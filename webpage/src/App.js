  ...
  updateState() {
         ...
         if(found === 1){
           if(this.state.inputPostalCode === "00100")
            ...
            if(this.state.inputPostalCode === "00120")
             this.setState({
               location: 'Punavuori',
             ...
             if(this.state.inputPostalCode === "00130")
              this.setState({
              ...
              if(this.state.inputPostalCode === "00140")
               this.setState({
               ...
               if(this.state.inputPostalCode === "00150")
                this.setState({
                  location: 'Kaivopuisto - Ullanlinna',
                  data: 'Predicted price: 1860 eur',
                  img1: asm00150,
               ...
               if(this.state.inputPostalCode === "00700")
                this.setState({
                  location: 'Malmi',
              ...
              if(this.state.inputPostalCode === "00980")
               this.setState({
               ...
               if(this.state.inputPostalCode === "02230")
                this.setState({
                  location: 'Matinkylä',
           ...
           this.setState({data: 'Data not found. Here are some average statistics for Helsinki region:'})
         }
    ...
    return (
      <div className="App">
        ...
        <p className="App-intro">
          To get started, please enter the required parameters in the text fields.
        </p>
        <div>
        ...
        <img src={this.state.img3} alt="" style={{left: '100px',top: '1350px',position: 'absolute'}}/>
